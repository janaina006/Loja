...
isset($_POST['cli_cpf'])){
    //variaveis
     ...
     if($_SESSION['CLI']['cli_pass'] != md5($cli_senha)){
         ...
         echo '<div class="alert alert-danger"> <p>A senha 
         para confirmar a alteração está incorreta</p>';
     ...
     $clientes->Preparar($cli_nome, $cli_sobrenome, $cli_data_nasc, $cli_rg, $cli_cpf, $cli_ddd, $cli_celular, $cli_endereco, $cli_numero, $cli_bairro, $cli_cidade, $cli_uf, $cli_cep, $cli_email, $cli_data_cad, $cli_hora_cad, $cli_senha);
     
     if(!$clientes->Editar($_SESSION['CLI']['cli_id'])){
        echo '<div class="slert alert-danger">Ocorreu um erro
        ao tentar editar os dados</div>';
        exit();
