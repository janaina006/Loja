...
class Clientes extends Conexao{
    ...
    function Preparar($cli_nome, $cli_sobrenome , $cli_data_nasc, $cli_rg,
            $cli_cpf , $cli_ddd  , $cli_celular , $cli_endereco , $cli_numero,
    ...
    function GetClientes(){
        ...
        $query = " SELECT * FROM {$this->prefix}cliente ";
 ...
 private function GetLista(){
    ...
    function Inserir(){
        if($this->GetClienteCPF($this->getCli_cpf()) > 0){
            ...
            id="erro_mostrar"> Este CPF já existe';
        ...
        if($this->GetClienteEmail($this->getCli_email()) > 0){
            echo '<div class="alert alert-danger"
            id="erro_mostrar"> Este Email já existe';
            Sistema::VoltarPagina();
            echo '</div>';
            exit();
        }
        ...
        $query = " INSERT INTO {$this->prefix}cliente (cli_nome, cli_sobrenome,cli_data_nasc,cli_rg,";
        $query .=" cli_cpf, cli_ddd,cli_celular ,cli_endereco ,cli_numero,cli_bairro ,";
    ...
    function Editar($id){
      ...
      $query = " UPDATE {$this->prefix}cliente SET cli_nome=:cli_nome, cli_sobrenome=:cli_sobrenome,cli_data_nasc=:cli_data_nasc,cli_rg=:cli_rg,";
...
//  echo $query;
    ...
    function SenhaUpdate($senha, $email){
    	$query = "UPDATE {$this->prefix}cliente SET cli_pass = :senha";
    	$query .= " WHERE cli_email = :email ";
