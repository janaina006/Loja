...
class Login extends Conexao{
	...
	static function AcessoNegado(){
		echo '<div class="alert alert-danger"> Acesso Negado, faça login! </div>';
	}
	...
	static function Logado(){
		if(isset($_SESSION['CLI']['cli_email']) && isset(
			$_SESSION['CLI']['cli_id'])){
				return TRUE;
	...
	static function LogadoADM(){
		if(isset($_SESSION['ADM']['user_nome']) && isset(
			$_SESSION['ADM']['user_id'])){
				return TRUE;
	...
	// função para mostrar o meno do cliente
