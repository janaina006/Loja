...
private function GetLista(){
    ...
    $this->itens[$i]=array(
        ...
        'cate_link' => Rotas::pag_Produtos(). '/' .$lista['cate_id'] . 
        '/' .  $lista['cate_slug'] ,
        'cate_link_adm' => Rotas::pag_ProdutosADM(). '/' .$lista['cate_id'] . 
        '/' .  $lista['cate_slug'] ,
    ...
    function Inserir($cate_nome){
        ...
        // monto a SQL
        $query = " INSERT INTO {$this->prefix}categoria(cate_nome, cate_slug )";
